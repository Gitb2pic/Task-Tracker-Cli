Voici un exemple de fichier `README.md` pour le projet **Task Tracker CLI** de roadmap.sh, adapté en français et conforme aux spécifications du projet.([roadmap.sh][1])
